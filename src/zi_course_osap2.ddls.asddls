...
@EndUserText.label: 'Data Definition for ZCOURSE_OSAP2'
define root view entity ZI_COURSE_OSAP2 as select from zcourse_osap2 as Course
  composition [0..*] of ZI_SCHEDULE_OSAP2 as _Schedule
