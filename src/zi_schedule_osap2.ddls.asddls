...
define view entity ZI_SCHEDULE_OSAP2 as select from zschedule_osap2 as Schedule
  association to parent ZI_COURSE_OSAP2 as _Course on $projection.CourseUuid = _Course.CourseUuid
{
